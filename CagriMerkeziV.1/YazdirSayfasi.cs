...
{
    public partial class YazdirSayfasi : Form
    {
        ...
        private void çALIŞANToolStripMenuItem_Click(object sender, EventArgs e)
        {
            cnn.Open();
            SqlDataAdapter da = new SqlDataAdapter("Select * from Calisan", cnn);
            DataSet dt = new DataSet();
            da.Fill(dt, "Calisan");
            dataGridView1.DataSource = dt.Tables["Calisan"];
            da.Dispose();
            cnn.Close();
        }
        ...
        private void gÖRÜŞMEKAYDIToolStripMenuItem_Click(object sender, EventArgs e)
        {
            cnn.Open();
        ...
        {
            cnn.Open();
            SqlDataAdapter da = new SqlDataAdapter("Select * from Gorev", cnn);
            DataSet dt = new DataSet();
            da.Fill(dt, "Gorev");
            ...
            try
            {
                ...
                while (iRow <= dataGridView1.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (bNewPage)
                        {
                            e.Graphics.DrawImage(Properties.Resources.logo_sp, 220, -50);
